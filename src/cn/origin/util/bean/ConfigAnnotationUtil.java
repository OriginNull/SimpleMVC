package cn.origin.util.bean;

import java.lang.annotation.Annotation;
import java.lang.reflect.Method;
import java.util.HashMap;
import java.util.Map;
import cn.origin.util.web.annotation.Controller;
import cn.origin.util.web.annotation.Repository;
import cn.origin.util.web.annotation.RequestMapping;
import cn.origin.util.web.annotation.Service;
...
public class ConfigAnnotationUtil {
	...
	private void classHandle() {
		...
		for (Annotation anto : annotations) { // 取出每一个注解
			if (anto.annotationType().equals(Controller.class)) { // 配置控制层注解
				...
				this.methodHandle(parentUrl); // 方法的获取与映射信息的获取
